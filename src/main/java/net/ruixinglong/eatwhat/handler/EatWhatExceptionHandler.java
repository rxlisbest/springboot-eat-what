package net.ruixinglong.eatwhat.handler;

import net.ruixinglong.eatwhat.bean.ExceptionBean;
import net.ruixinglong.eatwhat.exception.*;
...
@ControllerAdvice
@ResponseBody
public class EatWhatExceptionHandler {
